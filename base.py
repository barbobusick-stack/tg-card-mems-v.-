...
SEED_CARDS = [
    ("кот на арбузе",   "Common",    10,  60),
    ("кот пропал...",    "Common",    15,  55),
    ("художник кот",     "Rare",      40,  25),
    ("Морской дракон", "Rare",      50,  20),
    ("кот аноминус","Epic",     177, 10),
    ("Алон",         "Epic",      204,  8),
    ("СУПЕР КОТ КАРТА", 400,  2),
    ("СУПЕР ФЕОЛЕТОВЫЙ КОТ КАРТА","Legendary",577,  1),
]
